...
namespace Assignment1_ClientWebApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(MyStore_G5Context context)
        {
            _context = context;
        }
        ...
        {
            var myStore_G5Context = _context.Products.Include(p => p.Category);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyStore_G5Context.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
